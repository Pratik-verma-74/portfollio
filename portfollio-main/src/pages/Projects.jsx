...
const DUMMY_PROJECTS = [
  ...
  {
    title: 'MedRep Pro – Smart MR Management System(wolter Pharmaceutical Pvt Ltd)',
    desc: 'MedRep Pro is a full-stack web app for Medical Representatives to manage doctors, orders, and payments. Features Google OAuth login, Appwrite cloud storage, separate Admin & MR panels, live MR tracking with real-time attendance, due tracking, report generation, and daily work management — all synced securely to the cloud.',
    ss: 'medrep_pro_ss.png',
    placeholder: '🏥',
    placeholderBg: 'linear-gradient(135deg, #1a0d28, #2e1050)',
    tech: ['HTML', 'CSS', 'JavaScript', 'Appwrite', 'Google OAuth', 'Admin Panel', 'MR Panel', 'Live Tracking', 'Cloud Storage', 'Attendance System'],
