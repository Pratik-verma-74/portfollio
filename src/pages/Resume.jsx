      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ margintop: 10, fontSize: 15, color: "#ccc" }}>
              3rd Year B.C.A — AI & Data Science | B.N.M.U University 
            </p>
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            <li>
              <strong>B.C.A :- Bechlor of Computer Applications</strong> — BNMU
              (Bhupendra Narayan Mandal University), 2023–2026 <br />
              <span style={{ color: "#aaa" }}>GPA: 9.0</span>
            </li>
            <li style={{ marginTop: 8 }}>
              <strong>12th Board — Swami Vivekanand Inter College</strong> (Bihar
              Board, 2023) <br />
              <span style={{ color: "#aaa" }}>Percentage: 66.6%</span>
            </li>
            <li style={{ marginTop: 8 }}>
              <strong>10th Board — Madhuram High School Gwalpara</strong> (Bihar Board, 2021)
              <br />
        ...
        >
          {[
            { name: "🏆 LeetCode", link: "https://leetcode.com/u/Pratikverma/" },
            { name: "💻 GitHub", link: "https://github.com/Pratik-verma-74" },
            { name: "💼 LinkedIn", link: "https://www.linkedin.com/in/pratik-verma-177b49299/" },
          ].map((site) => (
            <motion.a
              key={site.name}
              href={site.link}
